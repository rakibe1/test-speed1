...
export default function SpeedTestInterface() {
  ...
  const getStatusMessage = () => {
    switch (state) {
      ...
      case "testing":
        return "Running speed test, please wait..." // More descriptive message
      case "finished":
        return "Speed test completed!" // Simplified message as authentication is not required
      case "error":
  ...
  // Determine which values to display: final results if available, otherwise current (which will be 0 until finished)
