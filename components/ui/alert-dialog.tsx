...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action ref={ref} className={cn(alertDialogButtonVariants(), className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={cn(alertDialogButtonVariants({ variant: "outline" }), "mt-2 sm:mt-0", className)}
    {...props}
  />
))
